...
GUI 层：使用 Dear ImGui 构建，采用 DirectX 11 硬件加速渲染。
...
📖 使用指南
连接设备：点击“刷新设备列表”，确认序列号正确后点击“连接镜像窗口”。

摇杆设置：在控制面板中调整 g_JoyX 和 g_JoyY，使其对准游戏内的虚拟摇杆中心。

键盘操控：保持软件窗口置顶，即可通过键盘 W/A/S/D 控制人物移动。
